...
#ifdef __USE_SVE__
    inline void static add_sve(svuint64_t &st0, svuint64_t &st1, svuint64_t &st2, const Goldilocks::Element C[SPONGE_WIDTH]);
    inline void static pow7_sve(svuint64_t &st0, svuint64_t &st1, svuint64_t &st2);
    inline void static add_sve_a(svuint64_t &st0, svuint64_t &st1, svuint64_t &st2, const Goldilocks::Element C[SPONGE_WIDTH]);
    inline void static add_sve_small(svuint64_t &st0, svuint64_t &st1, svuint64_t &st2, const Goldilocks::Element C[SPONGE_WIDTH]);
#endif
...
#ifdef __USE_SVE__
    void static merkletree_sve(Goldilocks::Element *tree, Goldilocks::Element *input, uint64_t num_cols, uint64_t num_rows, int nThreads = 0, uint64_t dim = 1);
    void static merkletree_batch_sve(Goldilocks::Element *tree, Goldilocks::Element *input, uint64_t num_cols, uint64_t num_rows, uint64_t batch_size, int nThreads = 0, uint64_t dim = 1);
#endif  // __USE_SVE__
...
#ifdef __USE_SVE__
#include "poseidon_goldilocks_sve.hpp"
#endif
