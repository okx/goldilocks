...
public:
    ...
    void static merkletree_part(Goldilocks::Element *tree, Goldilocks::Element *input, uint64_t num_cols, uint64_t num_rows, uint64_t part_size, uint64_t dim = 1);
    void static merkletree_part_seq(Goldilocks::Element *tree, Goldilocks::Element *input, uint64_t num_cols, uint64_t num_rows, uint64_t part_size, uint64_t dim = 1);
