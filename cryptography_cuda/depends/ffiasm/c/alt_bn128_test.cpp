...
namespace
{
    ...
    TEST(altBn128, fft)
    {
        ...
        std::string a0_str = Fr.toString(a[0], 10);
        std::string a1_str = Fr.toString(a[1], 10);
        std::cout << "a0_str: " << a0_str << std::endl;
        std::cout << "a1_str: " << a1_str << std::endl;
  

        FFT<typename Engine::Fr> fft(NMExp);

        fft.fft(a, NMExp);
        std::string a0_fft_str = Fr.toString(a[0], 10);
        std::string a1_fft_str = Fr.toString(a[1], 10);
        std::cout << "a0_fft_str: " << a0_fft_str << std::endl;
        std::cout << "a1_fft_str: " << a1_fft_str << std::endl;
        fft.ifft(a, NMExp);
