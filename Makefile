...
testsgpu: tests/tests.cpp $(ALLSRCS)
	...
	$(CXX) -D__USE_CUDA__ -DFEATURE_GOLDILOCKS src/ntt_goldilocks.cpp -fPIC  -g -Wall -pthread -fopenmp -mavx2 -c -IIcryptography_cuda -Icryptography_cuda/depends/blst/src -I/usr/local/cuda/include -Icryptography_cuda/cuda -o ntt_goldilocks.o
