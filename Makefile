...
testsgpu: tests/tests.cpp $(ALLSRCS)
	...
	$(NVCC) -D__USE_CUDA__ -Xcompiler -fopenmp -Xcompiler -fPIC -Xcompiler -mavx2 cryptography_cuda/src/lib.cu -Icryptography_cuda/cuda -Icryptography_cuda/depends/blst/src -arch=$(CUDA_ARCH) -g -dc --output-file ntt_gpu.o
